...
<head>
    ...
    <title>VIP2CARS — Error del servidor</title>
    ...
    <style>
        ...
        * { box-sizing:border-box; margin:0; padding:0; }
        ...
        .icon { font-size:3rem; color:#ef4444; margin-bottom:1rem; opacity:.8; }
    </style>
</head>
<body>
    <div class="error-container">
        ...
        <div class="error-title">Error <span>del Servidor</span></div>
        <p class="error-desc">
            Ocurrió un error interno. Nuestro equipo ha sido notificado.<br>
